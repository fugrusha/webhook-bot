...
@Component
public class HaveAQuestionButtonHandler implements InputMessageHandler {
    ...
    public BotState getHandlerName() {
        return BotState.HAVE_A_QUESTION;
    }

    private SendMessage processUserInput(Message inputMsg) {
        long chatId = inputMsg.getChatId();

        SendMessage replyToUser = messageService.getReplyMessage(chatId, "reply.callOrWrite");
